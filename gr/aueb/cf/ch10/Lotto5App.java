...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("/Users/pavlospoulos/IdeaProjects/CodingFactory/tmp/lotto5in.txt"));
             PrintStream ps = new PrintStream("/Users/pavlospoulos/IdeaProjects/CodingFactory/tmp/lotto5out.txt", StandardCharsets.UTF_8)) {
    ...
    /**
     * Returns true if the number of evens is greater than the given threshold.
     * @param arr
     *              the input array.
     * @param threshold
